...
fibonacci = """
0  read r1 # Get n
1  setn r2 0 # First number in sequence
2  setn r3 1 # Second number in sequence
3  jeqzn r1 13 # Halt the program when r1 = 0
4  write r2 # Prints first number in sequence
5  addn r1 -1 # r1 becomes r1 -1
6  add r4 r2 r3 # Adds together numbers
7  addn r1 -1 # Counter
8  write r4 # Prints the sum of r2 and r3
9 copy r3 r2 # r3 becomes r2 
10 copy r2 r4 # r2 becomes r4
11 jeqzn r1 13 # Halt the program when r1 = 0
12 jumpn 6 # Repeat from 6
13 halt # Stops the program
"""


# Set this variable to whichever program you wnt to execute
